...
║       ╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝               ║
║                                                           ║
║         Web Developer  ·  Cybersecurity  ·  Guinea        ║
╚═══════════════════════════════════════════════════════════╝
```

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&pause=1000&color=2D6A4F&center=true&vCenter=true&width=500&lines=Full-Stack+Web+Developer;Cybersecurity+Enthusiast;Founder+%40GnakryTech;AI+Agent+Builder;Building+from+Conakry+to+the+World+%F0%9F%8C%8D)](https://git.io/typing-svg)
...
amadou = {
    ...
    "role"        : ["Web Developer", "Cybersecurity Specialist", "Entrepreneur", "AI Builder"],
    "ventures"    : ["GnakryTech", "Vertex Shop", "The Amah", "Amah Agent"],
    "currently"   : "Building digital products for West Africa & beyond",
    "languages"   : ["French 🇫🇷", "English 🇬🇧"],
    "available"   : True  # Open to freelance & remote opportunities
}
```

I'm a self-taught developer and entrepreneur based in Conakry, Guinea.  
I build **modern web experiences**, **AI-powered tools**, and help businesses stay **secure online** —  
from e-commerce stores to local Windows AI agents, all crafted with precision.
...
![Anthropic](https://img.shields.io/badge/Anthropic_API-D4723A?style=for-the-badge&logo=anthropic&logoColor=white)
![Python](https://img.shields.io/badge/PyInstaller-3776AB?style=for-the-badge&logo=python&logoColor=white)
...
|--------|-------------|-------|
| 🧠 **Amah Agent** | Assistant IA local Windows — 65 outils, mémoire SQLite, livrable .exe standalone | Python, Groq API (Llama 3.3 70B), tkinter, SQLite, PyInstaller |
...
- 🌱 Learning **cloud security** and **DevSecOps**
...
*"Building from Conakry, reaching the world."* 🇬🇳

![Visitor Count](https://komarev.com/ghpvc/?username=amadou11doumbouya10-lgtm&color=2D6A4F&style=flat-square&label=Profile+Views)
